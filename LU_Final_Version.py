...
def instructions():
    ...
    print()
    print("At the next questions, you will enter how much money you wish to play the game with. "
          "Each round costs $1 and each round, you get a token that is randomly generated by the computer that could win you back your money. "
          "The token could either be a DONKEY - where you get nothing - a HORSE or ZEBRA - where you get 50 cents - "
          "or a UNICORN - where you get $5!! Each round, you get the choice to leave the game and keep the money you have got left "
